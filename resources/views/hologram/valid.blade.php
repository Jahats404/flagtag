...
<body>
    <div class="container">
        ...
        <h1>S E L A M A T !</h1>
        <p class="subtitle">PRODUK ANDA BERHASIL TERVERIFIKASI</p>

        <div class="badge">
            <img src="{{ asset('landing-scan/originaltag.png') }}" alt="Original Produk">
        </div>

        <div class="info">
            Produk Yang Anda Beli Adalah Produk Asli !
        </div>
